...
const ExperienceCard = (props) => {
  return (
    <div className='bg-[#1f1f1f] px-4 md:px-10 py-6 rounded-lg my-4 text-left'>
        <div className='md:items-center gap-1  bg-[#5429cf] text-white p-3 rounded-md my-2 font-medium text-lg md:text-xl'><div className="flex leading-none">{props.role}</div> <div className="text-sm">{props.time}</div> </div>
