...
const Section6 = () => {
  return (
    <div className='dark w-full h-full flex items-center'>
        ...
        <div className="relative font-semibold text-[5vh] md:text-[9vh] leading-none pt-1 text-transparent bg-clip-text bg-cover bg-gradient-to-br from-purple-600 via-indigo-600 to-indigo-800 tracking-normal md:tracking-normal " style={{ backgroundImage: "linear-gradient(135deg, #6355d5 3%, #5429cf 40%, #491ad9 70%)" }}>
  Certifications
</div>
